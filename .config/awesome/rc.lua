...
--- Register widget
vicious.register(memwidget, vicious.widgets.mem, "MEM: <span color='#00ccff'><b>$1% ($2MB/$3MB)</b></span> | ", 13)

--- Initialize widget
cpuwidget = wibox.widget.textbox()
--- Register widget
--- vicious.register(cpuwidget, vicious.widgets.cpu, "CPU: <span color='#0066ff'><b>$1%, $2%, $3%, $4%</b></span> | ")
vicious.register(cpuwidget, vicious.widgets.cpu, function (widget, args)
                   return ("CPU: <span color='#0066ff'><b>%02d%%, %02d%%, %02d%%, %02d%%</b></span> | "):format(args[1], args[2], args[3], args[4])
end)

batterywidget = wibox.widget.textbox()
vicious.register(batterywidget, vicious.widgets.bat, "BAT: <span color='green'><b>$1$2</b></span> | ",67,"BAT0")
...
vicious.register(volumewidget, vicious.widgets.volume, " Vol: <span color='grey'>$1$2</span> | ",61, "Master")
